...
const vec4 TRAIL_COLOR = vec4(1.0, 1.0, 1.0, 0.06);
const float DURATION = 0.1;
// Only draw trail when cursor jumps more than this many cursor-widths — filters out typing
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  if (lineLength < DRAW_THRESHOLD * cursorSize) {
    return;
  }
